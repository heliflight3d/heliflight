...
static bool bstSlaveProcessFeedbackCommand(uint8_t bstRequest)
{
    ...
    switch (bstRequest) {
        ...
        case BST_RC_TUNING:
            ...
            bstWrite8(0); // currentControlRateProfile->thrMid8
            bstWrite8(0); //currentControlRateProfile->thrExpo8
    ...
    switch (bstWriteCommand) {
        ...
        case BST_SET_RC_TUNING:
            if (bstReadDataSize() >= 10) {
                ...
                bstRead8(); // currentControlRateProfile->thrMid8
                bstRead8(); // currentControlRateProfile->thrExpo8
